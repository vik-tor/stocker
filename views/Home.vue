  ...
  <div class="bg-gray-100 flex-1 p-6 md:mt-16">
    ...
    <div class="grid grid-cols-4 gap-6 xl:grid-cols-1">
      ...
      <div class="report-card">
        ...
        <div
          class="footer bg-white p-1 mx-4 border border-t-0 rounded rounded-t-none"
        ></div>
      </div>
      <!-- end card -->
      ...
      <div class="card-body grid grid-cols-2 gap-6 lg:grid-cols-1">
        <div class="p-8">
          ...
          <div class="mt-20 mb-2 flex items-center">
            ...
            <p class="text-black">
              <span class="num-2 text-green-400"></span
          ...
          <div class="flex items-center">
            ...
            <p class="text-black">
              <span class="num-2 text-red-400"></span
              ><span class="text-red-400">% revenue per sale</span> in
    ...
    <div class="grid grid-cols-3 gap-6 mt-6 xl:grid-cols-1">
      ...
      <div class="card">
        ...
        <!-- brawser -->
        <div
          class="p-6 flex flex-row justify-between items-center text-gray-600 border-b-0"
        >
          <div class="flex items-center">
      ...
      <div class="card col-span-2 xl:col-span-1">
        ...
        <table class="table-auto w-full text-left">
          ...
          <tbody class="text-gray-600">
            <tr>
              <td
                class="border border-l-0 px-4 py-2 text-center text-green-500"
              >
            ...
            <tr>
              <td
                class="border border-l-0 px-4 py-2 text-center text-yellow-500"
              >
                <i class="fad fa-circle"></i>
              </td>
            ...
            <tr>
              <td
                class="border border-l-0 border-b-0 px-4 py-2 text-center text-green-500"
              >
                <i class="fad fa-circle"></i>
              </td>
